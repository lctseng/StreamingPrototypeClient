			...
			for(int i=u_colStart;i<=u_colEnd;++i){
				for(int j=0;j<u_rows;++j){
					...
					if(dist < u_apertureSize){
						...
						if(columnTextureIndex == 0 && j == 0){
							rd = u_rf_to_rd0_0 * rf;
						}
						if(columnTextureIndex == 0 && j == 1){
							rd = u_rf_to_rd0_1 * rf;
						}
						if(columnTextureIndex == 0 && j == 2){
							rd = u_rf_to_rd0_2 * rf;
						}
						if(columnTextureIndex == 0 && j == 3){
							rd = u_rf_to_rd0_3 * rf;
						}
						if(columnTextureIndex == 0 && j == 4){
							rd = u_rf_to_rd0_4 * rf;
						}
						if(columnTextureIndex == 0 && j == 5){
							rd = u_rf_to_rd0_5 * rf;
						}
						if(columnTextureIndex == 0 && j == 6){
							rd = u_rf_to_rd0_6 * rf;
						}
						if(columnTextureIndex == 0 && j == 7){
							rd = u_rf_to_rd0_7 * rf;
						}
						if(columnTextureIndex == 1 && j == 0){
							rd = u_rf_to_rd1_0 * rf;
						}
						if(columnTextureIndex == 1 && j == 1){
							rd = u_rf_to_rd1_1 * rf;
						}
						if(columnTextureIndex == 1 && j == 2){
							rd = u_rf_to_rd1_2 * rf;
						}
						if(columnTextureIndex == 1 && j == 3){
							rd = u_rf_to_rd1_3 * rf;
						}
						if(columnTextureIndex == 1 && j == 4){
							rd = u_rf_to_rd1_4 * rf;
						}
						if(columnTextureIndex == 1 && j == 5){
							rd = u_rf_to_rd1_5 * rf;
						}
						if(columnTextureIndex == 1 && j == 6){
							rd = u_rf_to_rd1_6 * rf;
						}
						if(columnTextureIndex == 1 && j == 7){
							rd = u_rf_to_rd1_7 * rf;
						}
						if(columnTextureIndex == 2 && j == 0){
							rd = u_rf_to_rd2_0 * rf;
						}
						if(columnTextureIndex == 2 && j == 1){
							rd = u_rf_to_rd2_1 * rf;
						}
						if(columnTextureIndex == 2 && j == 2){
							rd = u_rf_to_rd2_2 * rf;
						}
						if(columnTextureIndex == 2 && j == 3){
							rd = u_rf_to_rd2_3 * rf;
						}
						if(columnTextureIndex == 2 && j == 4){
							rd = u_rf_to_rd2_4 * rf;
						}
						if(columnTextureIndex == 2 && j == 5){
							rd = u_rf_to_rd2_5 * rf;
						}
						if(columnTextureIndex == 2 && j == 6){
							rd = u_rf_to_rd2_6 * rf;
						}
						if(columnTextureIndex == 2 && j == 7){
							rd = u_rf_to_rd2_7 * rf;
						}
						if(columnTextureIndex == 3 && j == 0){
							rd = u_rf_to_rd3_0 * rf;
						}
						if(columnTextureIndex == 3 && j == 1){
							rd = u_rf_to_rd3_1 * rf;
						}
						if(columnTextureIndex == 3 && j == 2){
							rd = u_rf_to_rd3_2 * rf;
						}
						if(columnTextureIndex == 3 && j == 3){
							rd = u_rf_to_rd3_3 * rf;
						}
						if(columnTextureIndex == 3 && j == 4){
							rd = u_rf_to_rd3_4 * rf;
						}
						if(columnTextureIndex == 3 && j == 5){
							rd = u_rf_to_rd3_5 * rf;
						}
						if(columnTextureIndex == 3 && j == 6){
							rd = u_rf_to_rd3_6 * rf;
						}
						if(columnTextureIndex == 3 && j == 7){
							rd = u_rf_to_rd3_7 * rf;
						}
						if(columnTextureIndex == 4 && j == 0){
							rd = u_rf_to_rd4_0 * rf;
						}
						if(columnTextureIndex == 4 && j == 1){
							rd = u_rf_to_rd4_1 * rf;
						}
						if(columnTextureIndex == 4 && j == 2){
							rd = u_rf_to_rd4_2 * rf;
						}
						if(columnTextureIndex == 4 && j == 3){
							rd = u_rf_to_rd4_3 * rf;
						}
						if(columnTextureIndex == 4 && j == 4){
							rd = u_rf_to_rd4_4 * rf;
						}
						if(columnTextureIndex == 4 && j == 5){
							rd = u_rf_to_rd4_5 * rf;
						}
						if(columnTextureIndex == 4 && j == 6){
							rd = u_rf_to_rd4_6 * rf;
						}
						if(columnTextureIndex == 4 && j == 7){
							rd = u_rf_to_rd4_7 * rf;
						}
						if(columnTextureIndex == 5 && j == 0){
							rd = u_rf_to_rd5_0 * rf;
						}
						if(columnTextureIndex == 5 && j == 1){
							rd = u_rf_to_rd5_1 * rf;
						}
						if(columnTextureIndex == 5 && j == 2){
							rd = u_rf_to_rd5_2 * rf;
						}
						if(columnTextureIndex == 5 && j == 3){
							rd = u_rf_to_rd5_3 * rf;
						}
						if(columnTextureIndex == 5 && j == 4){
							rd = u_rf_to_rd5_4 * rf;
						}
						if(columnTextureIndex == 5 && j == 5){
							rd = u_rf_to_rd5_5 * rf;
						}
						if(columnTextureIndex == 5 && j == 6){
							rd = u_rf_to_rd5_6 * rf;
						}
						if(columnTextureIndex == 5 && j == 7){
							rd = u_rf_to_rd5_7 * rf;
						}
						if(columnTextureIndex == 6 && j == 0){
							rd = u_rf_to_rd6_0 * rf;
						}
						if(columnTextureIndex == 6 && j == 1){
							rd = u_rf_to_rd6_1 * rf;
						}
						if(columnTextureIndex == 6 && j == 2){
							rd = u_rf_to_rd6_2 * rf;
						}
						if(columnTextureIndex == 6 && j == 3){
							rd = u_rf_to_rd6_3 * rf;
						}
						if(columnTextureIndex == 6 && j == 4){
							rd = u_rf_to_rd6_4 * rf;
						}
						if(columnTextureIndex == 6 && j == 5){
							rd = u_rf_to_rd6_5 * rf;
						}
						if(columnTextureIndex == 6 && j == 6){
							rd = u_rf_to_rd6_6 * rf;
						}
						if(columnTextureIndex == 6 && j == 7){
							rd = u_rf_to_rd6_7 * rf;
						}
						if(columnTextureIndex == 7 && j == 0){
							rd = u_rf_to_rd7_0 * rf;
						}
						if(columnTextureIndex == 7 && j == 1){
							rd = u_rf_to_rd7_1 * rf;
						}
						if(columnTextureIndex == 7 && j == 2){
							rd = u_rf_to_rd7_2 * rf;
						}
						if(columnTextureIndex == 7 && j == 3){
							rd = u_rf_to_rd7_3 * rf;
						}
						if(columnTextureIndex == 7 && j == 4){
							rd = u_rf_to_rd7_4 * rf;
						}
						if(columnTextureIndex == 7 && j == 5){
							rd = u_rf_to_rd7_5 * rf;
						}
						if(columnTextureIndex == 7 && j == 6){
							rd = u_rf_to_rd7_6 * rf;
						}
						if(columnTextureIndex == 7 && j == 7){
							rd = u_rf_to_rd7_7 * rf;
						}
